...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.longcat/version';Storage.PREFIX='com.martinmagni.longcat/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){console.log("leveldata")/*navigator.sendBeacon('https://leveldata.poki.io/fancade-5BFC1C2A246D67DD','948d3db9-a37d-4625-88aa-40c92f815ef7');*/}
